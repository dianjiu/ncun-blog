...
CREATE TABLE `t_blog` (
                          ...
                          `blog_grade` int(4) DEFAULT NULL COMMENT '文章热度（10表示置顶）',
                          `blog_author` varchar(255) NOT NULL COMMENT '文章作者',
                          `blog_imgs` varchar(255) DEFAULT NULL COMMENT '缩略图像',
                          `blog_url` varchar(255) DEFAULT NULL COMMENT '文章路径',
                          `blog_likes` bigint(20) DEFAULT NULL COMMENT '文章点赞数',
