...
public class SnowFlakeUtils {
    ...
    // ==============================Fields===========================================
    /**
     * 开始时间截 (2020-01-08 21:32:22)
     */

    private final long twepoch = 1578490342000L;
     ...
     * @return
     */
    public static List<Long> getSnowIds(int nums){
    ...
    public static void main(String[] args) {
        List<Long> snowIds = getSnowIds(10);
        for (Long snowId : snowIds) {
